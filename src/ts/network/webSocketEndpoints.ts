...
export function initializeWebSocket() {
    // Get settings
    const wsRelayUrl = game.settings.get(moduleId as ClientSettings.Namespace, "wsRelayUrl" as ClientSettings.KeyFor<any>) as string;
    const apiKey = game.settings.get(moduleId as ClientSettings.Namespace, "apiKey" as ClientSettings.KeyFor<any>) as string;
